    ...
    F: Write + ?Sized,
{
    match **t {
        ...
        ast::TypeSpecifierNonArrayData::UMat2 => f.write_str("umat2"),
        ast::TypeSpecifierNonArrayData::UMat3 => f.write_str("umat3"),
        ast::TypeSpecifierNonArrayData::UMat4 => f.write_str("umat4"),
        ast::TypeSpecifierNonArrayData::UMat22 => f.write_str("umat2x2"),
        ast::TypeSpecifierNonArrayData::UMat23 => f.write_str("umat2x3"),
        ast::TypeSpecifierNonArrayData::UMat24 => f.write_str("umat2x4"),
        ast::TypeSpecifierNonArrayData::UMat32 => f.write_str("umat3x2"),
        ast::TypeSpecifierNonArrayData::UMat33 => f.write_str("umat3x3"),
        ast::TypeSpecifierNonArrayData::UMat34 => f.write_str("umat3x4"),
        ast::TypeSpecifierNonArrayData::UMat42 => f.write_str("umat4x2"),
        ast::TypeSpecifierNonArrayData::UMat43 => f.write_str("umat4x3"),
        ast::TypeSpecifierNonArrayData::UMat44 => f.write_str("umat4x4"),
    ...
    F: Write + ?Sized,
{
    match **q {
        ...
        ast::StorageQualifierData::Static => f.write_str("static"),
        ast::StorageQualifierData::Extern => f.write_str("extern"),
        ast::StorageQualifierData::Inline => f.write_str("inline"),
